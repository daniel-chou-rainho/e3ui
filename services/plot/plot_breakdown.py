...
def plot_breakdown(data=None, figure=None, selected_app_id=None):
    ...
    if data is not None and not data.empty and selected_app_id:
        ...
        ax.barh(consumption_df_sorted['EnergyType'], consumption_df_sorted['TotalConsumption']/3600/1000)
        ax.set_title(f'Energy Consumption Breakdown for {selected_app_id}')  # Darker green color for the title
